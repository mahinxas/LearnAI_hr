...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-parchment-50">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-72 transform border-r border-midnight-100 bg-midnight-950 text-parchment-100 transition-transform duration-300 lg:translate-x-0 ${
            ...
            {navItems.map((item, i) => (
              ...
              >
                <span className="flex items-center gap-3">
                  <span className="font-mono text-[10px] tabular-nums text-midnight-400">
        ...
        <header className="sticky top-0 z-20 border-b border-midnight-100 bg-parchment-50/85 backdrop-blur-md">
          <div className="flex items-center justify-between px-6 py-4 md:px-10">
            <button
              ...
              className="grid h-10 w-10 place-items-center rounded-xl border border-midnight-200 bg-white text-midnight-950 lg:hidden"
            ...
            <div className="hidden items-center gap-3 lg:flex">
              <Logo size="sm" />
              <span className="h-1 w-1 rounded-full bg-midnight-300" />
              <span className="eyebrow !text-midnight-700">
